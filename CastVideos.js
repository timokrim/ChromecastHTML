...
CastPlayer.prototype.addVideoThumbs = function() {
    ...
    for (var i = 0; i < this.mediaContents.length; i++) {
        ...
        newdiv.innerHTML =
            ...
            '" class="thumbnail">';
            '<h1>' + MEDIA_SOURCE_ROOT + this.mediaContents[i]['title'] +
            '</h1>';
        
        divIdName = 'title' + i + 'Div';
        newdiv.setAttribute('id', divIdName);
        ...
        divIdName = 'subtitle' + i + 'Div';
        newdiv.setAttribute('id', divIdName);
        newdiv.setAttribute('class', 'subtitle');
        newdiv.innerHTML +=
            '<h1>' + MEDIA_SOURCE_ROOT + this.mediaContents[i]['subtitle'] +
            '</h1>';
